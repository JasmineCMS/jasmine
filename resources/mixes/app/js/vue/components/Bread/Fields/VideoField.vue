<template>
    <div>
        <div class="input-group mb-3">
            <input class="form-control" :class="{'is-invalid': invalid}"
                   :placeholder="opts.placeholder"
                   :pattern="opts.pattern"
                   :readonly="opts.readonly"
                   dir="ltr"
                   :required="validation.indexOf('required') > -1"
                   :id="id" :name="name+'[url]'" v-model="field_value.url">
            <div class="input-group-append">
                <div class="input-group-text">
                    <div class="type-icon" :class="{'active': field_value.type === 'youtube'}">
                    ...
                    <div class="type-icon" :class="{'active': field_value.type === 'vimeo'}">
                    ...
                    <div class="type-icon" :class="{'active': field_value.type === 'url'}">
        ...
        <input type="hidden" :name="name+'[type]'" v-model="field_value.type">

        <div class="form-control d-inline-block p-2 mt-1">
            <div v-if="!field_value.type" class="d-flex justify-content-center align-items-center p-5"
                 style="background: #e6e6e6;height: 315px">
                <i class="fas fa-video" style="font-size: 5rem;"></i>
            </div>

            <iframe v-if="field_value.type === 'youtube'" width="100%" height="315"
                    :src="'https://www.youtube.com/embed/' + embed_val"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>

            <iframe v-if="field_value.type === 'vimeo'" width="100%" height="315"
                    :src="'https://player.vimeo.com/video/' + embed_val"
                    title="Vimeo video player" frameborder="0"
                    allow="autoplay; fullscreen; picture-in-picture"
                    allowfullscreen></iframe>

            <video v-if="field_value.type === 'url'" width="100%" height="315" controls>
                <source :src="field_value.url" type="video/mp4">
            </video>
        </div>
    </div>
</template>
