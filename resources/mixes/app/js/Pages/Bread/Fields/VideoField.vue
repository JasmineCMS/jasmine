  ...
  <div>
    <div class="input-group input-group-sm">
      <input class="form-control" :class="{'is-invalid': invalid}"
             ...
             :id="id" :name="name+'[url]'" v-model="val.url">
    ...
    <div class="form-control form-control-sm d-inline-block p-2">
      <div v-if="!val.type" class="d-flex justify-content-center align-items-center p-5"
           style="background: #e6e6e6;height: 315px">
        <i class="fas fa-video" style="font-size: 5rem;"></i>
      </div>

      <iframe v-if="val.type === 'youtube'" width="100%" height="315"
              :src="'https://www.youtube.com/embed/' + embed_val"
              title="YouTube video player" frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen></iframe>

      <iframe v-if="val.type === 'vimeo'" width="100%" height="315"
