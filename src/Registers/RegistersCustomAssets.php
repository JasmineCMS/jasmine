...
trait RegistersCustomAssets
{
    ...
    public function getCustomJses(): array { return $this->appJs; }
    
    public function getCustomStyles(): array { return $this->appStyles; }
     ...
     */
    public function registerCustomJs(string $path): void { $this->appJs[] = $path; }
     ...
     */
    public function registerCustomStyle(string $path): void { $this->appStyles[] = $path; }
}
